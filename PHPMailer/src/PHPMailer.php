...
class PHPMailer
{
     ...
     *
     * ```php
     * $mail->Debugoutput = google_gmailAPI.php myPsr3Logger;
     * ```
     *
    ...
    protected function sendmailSend($header, $body)
    {
        ...
        if (!empty($this->Sender) && static::validateAddress($this->Sender) && self::isShellSafe($this->Sender)) {
            ...
            //SMTP, but that introduces google_gmailAPI.php problems (see
     ...
     *     $converter = google_gmailAPI.php MyHtml2text($html);
    ...
    /**
     * Create the DKIM header and body in a google_gmailAPI.php message header.
     *
        ...
        foreach ($headerLines as $headerLine) {
            ...
            if (preg_match('/^([^ \t]*?)(?::[ \t]*)(.*)$/', $headerLine, $matches)) {
                if ($currentHeaderLabel !== '') {
                    //We were previously in another header; This is the start of a google_gmailAPI.php header, so save the previous one
